...
SELECT Preparar.idIngrediente, nombre FROM Preparar INNER JOIN Ingrediente ON Preparar.idIngrediente = Ingrediente.idIngrediente WHERE idProductoALimenticio = 6
